const Header=()=>{
    return (
        ...
        <h1 className="font-medium">Julien Nim</h1>
        <h2 className="font-medium mt-2 text-gray-500 mb-9">Design Engineer</h2>
        <p className="font-medium text-gray-400  row-auto">
